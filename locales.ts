...
export const translations = {
  en: {
    ...
    schedule_info_text: "Travel time: Gate 9 ↔ Gate 2 (2 min), Gate 2 ↔ North (10 min). Arrival times are estimates.",
  ...
  zh: {
    ...
    schedule_info_text: "行程时间：9号门 ↔ 2号门 (2分钟)，2号门 ↔ 北校 (10分钟)。到达时间仅供参考。",
